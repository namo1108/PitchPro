...
import { KV_KEYS, findCompetition, YOUTH_OR_WOMEN_TEAM_NAME_PATTERN } from "../lib/config.js";
...
export async function refreshNationalTeams(env) {
  ...
  try {
    ...
    const teams = (raw.response || [])
      ...
      .filter((team) => team?.national && !YOUTH_OR_WOMEN_TEAM_NAME_PATTERN.test(team.name || ""))
