...
// 더 좁혔다. K리그2 정규 경기는 전후반 90분+하프타임 15분+추가시간 다 합쳐도 보통 105분 안에는
// 끝나니, 그 이후까지 IN_PLAY/PAUSED로 남아있다면 상태 갱신이 늦은 것으로 보고 라이브 보정을 끈다.
const MAX_LIVE_MATCH_AGE_MS = 105 * 60 * 1000;
